    ...
    <ul class="navbar-nav mr-auto">
      ...
      if ($uid) {
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Uploads</a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" href="uploads.php">Uploads</a>
            <a class="dropdown-item" href="passages.php">Passages</a>
            <a class="dropdown-item" href="status.php">Servers status</a>
          </div>
        </li>
        <li class=nav-item><a class=nav-link href="explore.php">Explore</a></li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?=$ua['u_name'] ?></a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
