...
\header {
  subtitle = "GenCA1: known-cf-maj (2017-11-29 22:10)"
}

\markup \wordwrap \bold {
      \vspace #2
"#"1 (from midi/known-cf-maj.mid), Rule penalty: 1  \char ##x27F9  0, Distance penalty: 5, Cantus: low, Key: C
}
<<
\new Staff {
...
\markup \wordwrap \bold {
      \vspace #2
"#"2 (from midi/known-cf-maj.mid), Rule penalty: 61  \char ##x27F9  0, Distance penalty: 4, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"3 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
...
\markup \wordwrap \bold {
      \vspace #2
"#"4 (from midi/known-cf-maj.mid), Rule penalty: 101  \char ##x27F9  0, Distance penalty: 4, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"5 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: D\flat 
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
  \clef "treble" \key df \major  \accidentalStyle modern-cautionary
  \time 4/4
  % \set Score.barNumberVisibility = #(every-nth-bar-number-visible 4)
  % \override Score.BarNumber.break-visibility = ##(#f #t #t)
  \new Voice \with {
  ...
  {  \speakOff \revert NoteHead.style df'1
_\markup{ \teeny \on-color #(rgb-color 1 1 1) \pad-markup #0.4 \concat { T }  }
 \speakOff \revert NoteHead.style f'1
_\markup{ \teeny \on-color #(rgb-color 1 1 1) \pad-markup #0.4 \concat { \char ##x0111 tIII }  }
 \speakOff \revert NoteHead.style gf'1
_\markup{ \teeny \on-color #(rgb-color 1 1 1) \pad-markup #0.4 \concat { S }  }
...
\markup \wordwrap \bold {
      \vspace #2
"#"6 (from midi/known-cf-maj.mid), Rule penalty: 183  \char ##x27F9  0, Distance penalty: 8, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"7 (from midi/known-cf-maj.mid), Rule penalty: 1  \char ##x27F9  0, Distance penalty: 6, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"8 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
...
\markup \wordwrap \bold {
      \vspace #2
"#"9 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
...
\markup \wordwrap \bold {
      \vspace #2
"#"10 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
...
\markup \wordwrap \bold {
      \vspace #2
"#"11 (from midi/known-cf-maj.mid), Rule penalty: 101  \char ##x27F9  0, Distance penalty: 8, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"12 (from midi/known-cf-maj.mid), Rule penalty: 1  \char ##x27F9  0, Distance penalty: 6, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"13 (from midi/known-cf-maj.mid), Rule penalty: 0, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"1"
...
\markup \wordwrap \bold {
      \vspace #2
"#"14 (from midi/known-cf-maj.mid), Rule penalty: 61  \char ##x27F9  0, Distance penalty: 4, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"15 (from midi/known-cf-maj.mid), Rule penalty: 122  \char ##x27F9  0, Distance penalty: 4, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"16 (from midi/known-cf-maj.mid), Rule penalty: 61  \char ##x27F9  0, Distance penalty: 4, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
...
\markup \wordwrap \bold {
      \vspace #2
"#"17 (from midi/known-cf-maj.mid), Rule penalty: 1  \char ##x27F9  0, Distance penalty: 5, Cantus: low, Key: C
}
<<
\new Staff {
  \set Staff.instrumentName = #"2"
